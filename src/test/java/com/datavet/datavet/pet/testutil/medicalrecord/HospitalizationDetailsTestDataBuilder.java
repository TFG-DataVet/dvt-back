...
import com.datavet.datavet.pet.domain.model.details.hospitalization.ClinicalCondition;
...
public class HospitalizationDetailsTestDataBuilder {
    ...
    public static HospitalizationDetails anAdmittedHospitalization() {
        ...
        details.applyAction(com.datavet.datavet.pet.domain.model.action.RecordAction.ADMIT);
        return details;
    }
    ...
    public static HospitalizationDetails anInProgressHospitalization() {
        ...
        details.applyAction(com.datavet.datavet.pet.domain.model.action.RecordAction.START);
        return details;
    }
    ...
    public static HospitalizationDetails aCompletedHospitalization() {
        ...
        details.applyAction(com.datavet.datavet.pet.domain.model.action.RecordAction.COMPLETE);
        return details;
    }
    ...
    public static HospitalizationDetails aCancelledHospitalization() {
        HospitalizationDetails details = aValidScheduledHospitalization();
        details.applyAction(com.datavet.datavet.pet.domain.model.action.RecordAction.CANCEL);
        return details;
    }
    ...
    public static HospitalizationDetails aDeceasedHospitalization() {
        ...
        details.applyAction(com.datavet.datavet.pet.domain.model.action.RecordAction.DECLARE_DECEASED);
        return details;
    }
