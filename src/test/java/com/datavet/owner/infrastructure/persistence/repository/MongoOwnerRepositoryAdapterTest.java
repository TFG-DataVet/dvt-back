//package com.datavet.owner.infrastructure.persistence.repository;
//
...
//        assertEquals("23402587H", savedOwner.getDocumentNumber());
...
//        testOwner.setDocumentNumber(existingDni);
//        repository.save(testOwner);
//
//        // When: checking if the DNI exists
//        boolean exists = repository.existsByDocumentNumber(existingDni);
//
//        // Then: should return true
